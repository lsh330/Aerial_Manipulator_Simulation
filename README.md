...
| 지표 | 값 |
|------|-----|
| Position RMSE | 0.45 cm |
| Joint $q_1$ RMSE | 0.63° |
| Max attitude error | 1.15° |
...
|------|------|------------|-----------|
| Circle Position RMSE | **0.349 cm** | 0.762 cm | 1.907 cm |
| Arm Position RMSE | **0.45 cm** | 3.36 cm | 8.73 cm |
| Arm Joint $q_1$ RMSE | **0.63°** | 1.19° | 1.39° |
...
| `Q_position` | [2000, 2000, 3000] | 위치 추종 가중치 [x, y, z] |
| `Q_velocity` | [200, 200, 300] | 속도 추종 가중치 |
| `Q_angular_vel` | [20, 20, 10] | 각속도 추종 가중치 |
| `Q_joints` | [500, 500] | 관절 각도 추종 가중치 |
| `Q_joint_vel` | [10, 10] | 관절 각속도 추종 가중치 |
| `attitude_weight` | 1000 | Quaternion 자세 오차 가중치 |
| `R_motors` | [0.1, 0.1, 0.1, 0.1] | 로터 추력 입력 가중치 |
| `R_joints` | [0.05, 0.05] | 관절 토크 입력 가중치 |
...
| `solver_options.max_iter` | 30 | IPOPT 최대 반복 횟수 |
| `solver_options.tol` | 1e-4 | IPOPT 수렴 허용 오차 |
